...
contract Crowdsale {
     ...
     * addressOfToken: Where is the token contract deployed. This is the address of token we are selling.
     */
    function Crowdsale(
        ...
        token = OliCoin(0xcc2279b5a48b6cb2b7d0da014e74cbb4d95a5182);
